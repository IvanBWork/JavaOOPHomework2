...
public class SpecialClient extends Actor implements iActorBehaviour, iReturnOrder {
    ...
    /**
     * Метод получения имени особого клиента.
     * @return возвращает имя особого клиента.
     */
    @Override
    ...
    /**
     * Метод присвоения имени особого клиента.
     * @param name задаваемое имя особого клиента.
     */
    @Override
